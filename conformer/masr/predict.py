...
from conformer.masr import SUPPORT_MODEL
from conformer.masr.data_utils.audio import AudioSegment
from conformer.masr.data_utils.featurizer.audio_featurizer import AudioFeaturizer
from conformer.masr.data_utils.featurizer.text_featurizer import TextFeaturizer
from conformer.masr.decoders.ctc_greedy_decoder import greedy_decoder, greedy_decoder_chunk
from conformer.masr.infer_utils.inference_predictor import InferencePredictor
from conformer.masr.utils.logger import setup_logger
from conformer.masr.utils.utils import dict_to_object, print_arguments, download_model
...
class MASRPredictor:
    def __init__(self,
        ...
        # 加标点符号
        # if use_pun:
        #     from conformer.masr.infer_utils.pun_predictor import PunctuationPredictor
    ...
    def __init_decoder(self):
        ...
        if self.configs.decoder == "ctc_beam_search":
            try:
                from conformer.masr.decoders.beam_search_decoder import BeamSearchDecoder
