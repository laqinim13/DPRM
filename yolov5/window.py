...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        # self.model = self.model_load(weights="H:/re_project_3_1/yolov5/runs/train/exp9/weights/best.pt",
        #                              device=self.device)  # todo 指明模型加载的位置的设备

        self.model = self.model_load(weights="H:/re_project_3_1/yolov5/pretrained/yolov5s.pt",
                                     device=self.device)  # todo 指明模型加载的位置的设备
        self.initUI()
        self.reset_vid()
