...
def create_work_space(cfg, flag="", full_name=False):
    stime = file_utils.get_time()
    ...
    if full_name:
        ...
        name = [model_name, cfg.MODEL.NUM_JOINTS, cfg.MODEL.IMAGE_SIZE[0], cfg.MODEL.IMAGE_SIZE[1], filter,
                cfg.MODEL.OUT_TYPE, cfg.DATASET.ROT_FACTOR, cfg.DATASET.SCALE_RATE, flag, cfg.DATASET.DATASET, stime]
    else:
        name = [model_name, cfg.MODEL.NUM_JOINTS, cfg.MODEL.IMAGE_SIZE[0], cfg.MODEL.IMAGE_SIZE[1],
                cfg.DATASET.DATASET, flag, stime]
