...
if __name__ == "__main__":
    val_src_root = "/media/data/data/FaceRecognition/torch-Face-Recognize-Pipeline/data/val/"
    local_val_root = "/media/data/data/FaceRecognition/torch-Face-Recognize-Pipeline/data/val1/val"
    val_name = "X4"
