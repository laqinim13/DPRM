...
class VOCDataset(Dataset):
    ...
    def checking(self, image_ids: list):
        """
        '/home/data/dataset3/dataset/Character/gimage_v1/JPEGImages/image_000123.jpg'
        :param image_ids:
        :return:
        """
        dst_ids = []
    ...
    def crop_image(self, image, bbox):
        ...
        bboxes = image_utils.extend_bboxes([bbox], scale=[1.3, 1.3])
        images = image_utils.get_bboxes_crop_padding(image, bboxes)
    ...
    def read_files(filename, *args):
        ...
        if not filename:  # if None
            ...
            anno_list = []
            for a in args:
                anno_list += file_utils.get_files_list(a, postfix=["*.xml"])
...
if __name__ == "__main__":
    ...
    isshow = True
    # data_root = "/home/data/dataset3/dataset/MPII/"
    # data_root = "/media/data/data2/git/python-learning-notes/dataset/Test_Voc"
    # anno_dir = '/home/data/dataset3/dataset/finger/finger/Annotations'
    # image_dir = '/home/data/dataset3/dataset/finger/finger/JPEGImages'
    # data_root = "/home/data/dataset3/dataset/Character/gimage_v1/"
    # data_root = "/home/data/dataset3/dataset/finger/finger_v5/"
    # data_root = '/home/data/dataset3/dataset/Character/gimage_v1/'
    data_root = "/home/data/dataset3/dataset/hook_circle/SRC/v2/crop/"
    # data_root = "/home/data/dataset3/dataset/Character/gimage_v1"
    # data_root = "/home/data/dataset3/dataset/finger/finger_v3/"
    # data_root = "/home/data/dataset3/dataset/finger/finger_test/"
    # data_root = "/home/data/dataset3/dataset/OpenImages/"
    ...
    for i in range(len(voc)):
        ...
        if isshow:
            ...
            image = image_utils.draw_image_bboxes_text(image, boxes, boxes_name=boxes_name)
