...
def demo_for_rotate_point():
    ...
    for i in range(360):
        ...
        image_vis = image_utils.draw_points_text(image_vis, point1, texts=[str(i)] * len(point1), drawType="simple")
        image_vis = image_utils.draw_points_text(image_vis, point2, texts=[str(i)] * len(point1), drawType="simple")
