...
if __name__ == "__main__":
    pb_path = "/home/data/dataset3/git_project/torch-Human-Pose-Estimation-Pipeline/work_dir/finger4/custom_coco/model_mobilenet_v2_1.0_256x256_0.001_adam_finger_transforms_v1_2020-10-22-17-55/model/best_model_118_0.9507_optimize_int8.tflite"
    pbd = TFliteDetector(pb_path)
    test_images = np.zeros(shape=(1, 256, 256, 3), dtype=np.float32)
    out = pbd(test_images)
    print(out.shape)
